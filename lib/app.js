...
const connectionStr = "postgres://postgres:password@localhost/sqlhotel";
...
function start(options) {
    ...
    massive.connect({connectionString: connectionStr, scripts: 'database/sql'}, function(error, massiveInstance) {
